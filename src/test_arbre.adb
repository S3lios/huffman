...
procedure test_arbre is
   ...
   begin
    ...
    function Est_Egal_Entier(Entier1 : in Integer; Entier2 : in Integer) return Boolean is
    begin
   ...
   package arbre_b is new
     arbre(T_Element => Integer, Affichage_Element => Affichage_Entier, Est_Egal_Element => Est_Egal_Entier);
   use arbre_b;
